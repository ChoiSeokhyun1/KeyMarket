...
<body>
	...
	<div id="wrap2">
	<input type="text" id="titleInput" value="${qqq_tableDto.mostqboardTitle}">
	<textarea id="summernote">${qqq_tableDto.mostqboardContent}</textarea>
	</div>
    ...
    <div id="wrap3">
	 ...
	 <script>
        $('#comple').click(function() {
            ...
            var mostqboardNo = ${qqq_tableDto.mostqboardNo};
            ...
            $.ajax({
                ...
                url: 'updateProcessMostQ', // 데이터를 처리할 서버 측 JSP 파일
                data: {
                ...
                success: function(response) {
                    ...
                    window.location.href = 'viewBoardMostQ2?mostqboardNo=' + mostqboardNo;
                },
                error: function() {
