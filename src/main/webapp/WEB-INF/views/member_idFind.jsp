...
<body>
    ...
    <script>
       ...
       <div id="wrap">
        ...
        <br>
        <br>
        	<p>가입하신 이메일 또는 전화번호로 아이디 찾기가 가능합니다.</p>
        	<p>기억이 나지 않는 경우 <a href="" class="fontBold">Q&A 게시판</a>을 통해 문의해주세요.</p>
        	
        <form action="member_idFindResult" method="post" name="userInfo";>
	    ...
	    <option value="phone">전화번호</option>
		    ...
		    <div class="buttonCenter">
		       <input type="submit" value="아이디 찾기" id="joinButton" class="lastbutton" />
		    </div>
